...
| **[hearth-cli](https://pypi.org/project/hearth-cli/)** `PyPI` Project & sprint awareness in the terminal — one registry tracking project health, sprint load, and next actions across your machine. | **[anysession](https://pypi.org/project/anysession/)** `PyPI` One fzf picker over every resumable AI coding agent session — Claude Code, Codex, OpenCode, Hermes, and more. | **[More on PyPI](https://pypi.org/user/toshon/)** `PyPI` The rest of the shelf — every published package, installable with pip. |
